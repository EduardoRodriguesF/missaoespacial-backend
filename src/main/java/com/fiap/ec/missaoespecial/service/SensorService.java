...
import com.fiap.ec.missaoespecial.repository.SensorRepository;
...
public class SensorService {
    ...
    public Sensor buscarPorId(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new RuntimeException("Sensor não encontrada"));
    }
    ...
    public Sensor atualizar(Long id, Sensor sensorAtualizado) {
        ...
        sensorExistente.setModulo(sensorAtualizado.getModulo());
